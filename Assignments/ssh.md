...
hostname -I
```
<img width="1600" height="387" alt="image" src="https://github.com/user-attachments/assets/8d4a40be-8be0-48e9-91d7-07fd368fd96a" />
...
<img width="456" height="141" alt="image" src="https://github.com/user-attachments/assets/ed34403e-85b9-4c2f-97ca-71a36bcf8b0e" />


# ON MAC
<img width="465" height="291" alt="image" src="https://github.com/user-attachments/assets/bb812f48-1370-418f-8f5f-00361e6bc1b0" />


# 🌐 Case 2: Mac and Ubuntu on different networks (e.g., home ↔️ office or remote server)
...
hostname -I
![6de2e95aca6c38c9f83e5d2497e4dea0.png](:/9bdc919fb8424bb3bfa92fddd23841b8)

3. Log in to your router and port-forward port 22 to that IP.

4. Find your public IP (visit https://whatismyipaddress.com
5. From your Mac, connect via:
...
<img width="461" height="166" alt="image" src="https://github.com/user-attachments/assets/ab0c1259-8317-49d7-9660-c8ba3c8fc181" />

<img width="469" height="244" alt="image" src="https://github.com/user-attachments/assets/3876ed9c-8531-4dec-9d10-32495d2b67c4" />
